...
<script>
  import { validator } from '../../js_sdk/validator/project_task_tags.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'project_task_tags';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("project_id,task_id,name,color,created_at,updated_at").get().then((res) => {
