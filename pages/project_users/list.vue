<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="project_id,userid,owner,top_at,created_at,updated_at,deleted_at" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="range" @filter-change="filterChange($event, 'owner')" sortable @sort-change="sortChange($event, 'owner')">是否负责人</uni-th>
            <uni-th align="center" filter-type="timestamp" @filter-change="filterChange($event, 'top_at')" sortable @sort-change="sortChange($event, 'top_at')">置顶时间</uni-th>
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            ...
            <uni-td align="center">
              <uni-dateformat :threshold="[0, 0]" :date="item.top_at"></uni-dateformat>
            </uni-td>
            <uni-td align="center">
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/project_users.js';
