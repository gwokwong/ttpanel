<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="project_id,column_id,task_id,userid,detail,record,created_at,updated_at,deleted_at" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'detail')" sortable @sort-change="sortChange($event, 'detail')">详细信息</uni-th>
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'record')" sortable @sort-change="sortChange($event, 'record')">记录数据</uni-th>
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            ...
            <uni-td align="center">{{item.detail}}</uni-td>
            <uni-td align="center">{{item.record}}</uni-td>
            <uni-td align="center">
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/project_logs.js';
