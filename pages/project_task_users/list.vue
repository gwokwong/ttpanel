<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="project_id,task_id,task_pid,userid,owner,created_at,updated_at" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'task_pid')" sortable @sort-change="sortChange($event, 'task_pid')">任务ID（如果是子任务则是父级任务ID）</uni-th>
            ...
            <uni-th align="center" filter-type="range" @filter-change="filterChange($event, 'owner')" sortable @sort-change="sortChange($event, 'owner')">是否任务负责人</uni-th>
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            ...
            <uni-td align="center">{{item.task_pid}}</uni-td>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/project_task_users.js';
  ...
  export default {
    data() {
      return {
        collectionList: "project_task_users",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "project_task_users.xls",
          "type": "xls",
          "fields": {
            "项目ID": "project_id",
            "任务ID": "task_id",
            "任务ID（如果是子任务则是父级任务ID）": "task_pid",
            "用户id": "userid",
            "是否任务负责人": "owner",
            "创建时间": "created_at",
            "更新时间": "updated_at"
