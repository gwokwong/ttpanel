<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="userid,task_id,type,created_at,updated_at,deleted_at" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="range" @filter-change="filterChange($event, 'type')" sortable @sort-change="sortChange($event, 'type')">提醒类型：0 任务开始提醒，1 距离到期提醒，2到期超时提醒</uni-th>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/project_task_push_logs.js';
  ...
  export default {
    data() {
      return {
        collectionList: "project_task_push_logs",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "project_task_push_logs.xls",
          "type": "xls",
          "fields": {
            "用户id": "userid",
            "任务id": "task_id",
            "提醒类型：0 任务开始提醒，1 距离到期提醒，2到期超时提醒": "type",
            "创建时间": "created_at",
            "更新时间": "updated_at",
            "删除时间": "deleted_at"
          }
