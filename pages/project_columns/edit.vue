<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="name" label="项目列表名称">
        <uni-easyinput placeholder="列表名称" v-model="formData.name"></uni-easyinput>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/project_columns.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'project_columns';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("project_id,name,color,sort,created_at,updated_at,deleted_at").get().then((res) => {
