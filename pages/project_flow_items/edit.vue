  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("project_id,flow_id,name,status,turns,userids,usertype,userlimit,column_id,sort,created_at,updated_at,deleted_at").get().then((res) => {
