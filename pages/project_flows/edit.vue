<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="name" label="流程名称">
        <uni-easyinput placeholder="流程名称" v-model="formData.name"></uni-easyinput>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/project_flows.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'project_flows';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("project_id,name,created_at,updated_at,deleted_at").get().then((res) => {
