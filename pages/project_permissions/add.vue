<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="permissions" label="权限">
        <uni-easyinput placeholder="权限" v-model="formData.permissions"></uni-easyinput>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/project_permissions.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'project_permissions';
