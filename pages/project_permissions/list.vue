<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="project_id,permissions,created_at,updated_at,deleted_at" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'permissions')" sortable @sort-change="sortChange($event, 'permissions')">权限</uni-th>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/project_permissions.js';
  ...
  export default {
    data() {
      return {
        collectionList: "project_permissions",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "project_permissions.xls",
          "type": "xls",
          "fields": {
            "项目ID": "project_id",
            "权限": "permissions",
