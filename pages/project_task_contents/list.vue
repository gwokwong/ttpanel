<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="project_id,task_id,content,created_at,updated_at,deleted_at" :where="where" page-data="replace"
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/project_task_contents.js';
  ...
  export default {
    data() {
      return {
        collectionList: "project_task_contents",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "project_task_contents.xls",
          "type": "xls",
          "fields": {
            "项目ID": "project_id",
            "任务ID": "task_id",
